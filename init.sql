CREATE TABLE public.account_tag(
    ...
    alpha_test boolean DEFAULT false,
    pass text,
    PRIMARY KEY(id)
);
CREATE UNIQUE INDEX account_tag_uid_key ON public.account_tag USING btree ("uid");

-- Active: 1710119779815@@127.0.0.1@5432@prome@public
-- Generated by the database client.
CREATE TABLE public.account_v2(
    id SERIAL NOT NULL,
    uid text NOT NULL,
    ...
    news_letter_subscription boolean NOT NULL DEFAULT true,
    avatar text,
    third_party_login_field jsonb,
    register_type text,
    referrer text,
    wallets jsonb,
    social_account_google text,
    is_old_account boolean DEFAULT false,
    account_tag text,
    game_package_id text,
    blockus_sui_wallet text,
    parent varchar(128),
    paths text,
    address varchar(128) NOT NULL,
    PRIMARY KEY(id)
);
CREATE UNIQUE INDEX address_1711875587889_index ON public.account_v2 USING btree ("address");
COMMENT ON COLUMN public.account_v2.parent IS 'parent address';
COMMENT ON COLUMN public.account_v2.paths IS 'paths';
COMMENT ON COLUMN public.account_v2.address IS 'address';

-- Active: 1710119779815@@127.0.0.1@5432@prome@public
-- Generated by the database client.
CREATE TABLE public.account_v2_action_log(
    id SERIAL NOT NULL,
...
CREATE TABLE public.e4c_record(
    id SERIAL NOT NULL,
    e4c double precision NOT NULL,
...
-- Generated by the database client.
CREATE TABLE public.sui_nft_record(
    id SERIAL NOT NULL,
    sender text NOT NULL DEFAULT ''::text,
    receiver text NOT NULL DEFAULT ''::text,
    amount text NOT NULL DEFAULT ''::text,
    txtype text NOT NULL DEFAULT ''::text,
    digest text NOT NULL DEFAULT ''::text,
    checkpoint text NOT NULL DEFAULT ''::text,
    cointype text NOT NULL DEFAULT ''::text,
    objectid text DEFAULT ''::text,
    timestamp bigint NOT NULL,
    PRIMARY KEY(id)
);
...
CREATE TABLE public.coupon(
    id SERIAL NOT NULL,
    create_time date DEFAULT '2024-04-05'::date,
    address varchar(128),
    code varchar(20),
    status integer,
...
CREATE UNIQUE INDEX address_serial_1711984478042_index ON public.coupon USING btree ("address","serial");

CREATE TABLE public.task(
    id SERIAL NOT NULL,
    create_time timestamp without time zone DEFAULT '2024-03-24 11:22:45.968079'::timestamp without time zone,
    "type" varchar(20),
    status varchar(20),
    address varchar(128),
    content json,
